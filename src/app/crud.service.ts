...
export class CrudService {
  ...
  public  getAllDoctors = ():Observable<CustomRequest<Doctor>> =>{
    ...
    public  createDoctor = (doctor:Doctor):Observable<CustomRequest<Doctor>> =>{
      console.log(doctor);
      return this.http.post<CustomRequest<Doctor>>(`${this.url}/doctor/create`,doctor);}
      public  updateDoctor = (doctor:Doctor):Observable<CustomRequest<Doctor>> =>{
        console.log(doctor);
        return this.http.put<CustomRequest<Doctor>>(`${this.url}/doctor/update`,doctor);}
        public  deleteDoctor = (doctor:Doctor):Observable<CustomRequest<Doctor>> =>{
          console.log(doctor);
          this.id=doctor.pkUserId;
          return this.http.delete<CustomRequest<Doctor>>(`${this.url}/doctor/delete/`+this.id);}
